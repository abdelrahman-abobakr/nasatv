    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form method="POST" action="{{ route('admin.subscriptions.update', $subscription) }}">
            ...
            <div class="mb-4" x-data="{
                open: false,
                search: '',
                selectedId: '{{ old('added_by', $subscription->addedBy ? $subscription->addedBy->id : '') }}',
                selectedName: '',
                options: [
                ...
                <p class="text-xs text-gray-500 mt-1">Select an employee to assign this subscription to them. If left empty, it will be assigned to you.</p>
            </div>
